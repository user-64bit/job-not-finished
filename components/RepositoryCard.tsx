          ...
          <div className="space-y-2 relative">
            <div className="flex justify-between items-center">
              <motion.span 
                ...
                animate={{ 
                  color: (currentProgress || 0) === 100 ? 'var(--success)' : 'inherit' 
                }}
                ...
                {!isEditing ? (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Pencil size={14} className="transition-transform duration-200 group-hover:rotate-12" />
                      </Button>
                    </motion.div>
                  </motion.div>
                ) : (
                  ...
                  >
                    ...
                    >
                      <Input
                        ...
                        className={`transition-all duration-300 ${
                          progressValue === 100 ? 'border-green-500 focus-visible:ring-green-500' : ''
                        }`}
                      />
                      {progressValue === 100 && (
                        <motion.div 
                    ...
                    >
                      <Button
                        ...
                        disabled={isLoading}
                        className={`transition-all duration-300 ${
                          progressValue === 100 ? 'bg-green-500 hover:bg-green-600' : ''
                        }`}
                      >
                        {isLoading ? (
                          <Circle className="animate-spin" />
                        ) : (
                          <Save size={14} className="transition-transform duration-200 hover:rotate-12" />
                        )}
                      </Button>
                    </motion.div>
                  </motion.div>

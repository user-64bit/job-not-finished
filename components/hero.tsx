import { fadeIn, imageVariants, staggerContainer } from "@/utils/constant";
import { motion } from "framer-motion";
import { ArrowRight, Bell, CheckCircle, Clock, Github } from "lucide-react";
...
export const Hero = ({ isLoggedIn }: { isLoggedIn: boolean }) => {
  return (
    <main className="flex-1">
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground">
              Connect with your GitHub account to automatically import and track
              all your repositories in one place.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Visualize your project completion with intuitive progress bars and
          ...
          >
            ...
            <p className="text-muted-foreground">
              Receive weekly email reminders with motivational messages to keep
              you engaged with your projects.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Get detailed insights about your project activity, stars, and open
              issues to prioritize your work.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Receive friendly &quot;roasts&quot; that motivate you to continue
              working on your unfinished projects.
            </p>
          </motion.div>
      ...
      {/* CTA Section */}
      <motion.section variants={fadeIn} className="bg-primary/5 py-16 md:py-24">

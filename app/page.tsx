    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <span className="font-bold text-xl hidden sm:inline-block">Job Not Finished</span>
        </div>
        <div>
          {!isLoggedIn && (
            <Link href="/signin">
      ...
      <main className="flex-1">
        <section className="container mx-auto py-16 md:py-24 px-4 flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            >
              A powerful tool that helps developers track, manage, and complete their unfinished GitHub projects through motivation, progress tracking, and friendly reminders.
            </motion.p>
            <motion.div 
              variants={fadeIn}
            ...
            >
              ...
              <a href="#features" className="inline-block" onClick={(e) => {
                e.preventDefault();
        ...
        <section id="features" className="container mx-auto py-16 md:py-24 px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Use Job Not Finished?</h2>
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground">
                Connect with your GitHub account to automatically import and track all your repositories in one place.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Visualize your project completion with intuitive progress bars and set milestones to stay motivated.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Receive weekly email reminders with motivational messages to keep you engaged with your projects.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Get detailed insights about your project activity, stars, and open issues to prioritize your work.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">Motivational Roasts</h3>
              <p className="text-muted-foreground">
                Receive friendly &quot;roasts&quot; that motivate you to continue working on your unfinished projects.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">Repository Filtering</h3>
              <p className="text-muted-foreground">
                Filter repositories by language, search by name, and sort by various criteria to focus on what matters most.
              </p>
            </motion.div>
          </motion.div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Finish Your Projects?</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              Join thousands of developers who have transformed their unfinished projects into completed achievements.
            </p>
            {!isLoggedIn && (
              <Link href="/signin">
                <motion.div
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Job Not Finished. All rights reserved.
            </div>
          </div>
        </div>
      </motion.footer>
